...
_ARM_SETUP = {
    "gen5a": dict(gex_feature_source="weighted_linear", global_context_source="uni2_pool", gex_context_dim=None),
    "gen5b": dict(gex_feature_source="frozen_context", global_context_source="gigapath", gex_context_dim=CONTEXT_DIM),
    "gen5c": dict(gex_feature_source="frozen_context", global_context_source="uni2_pool", gex_context_dim=CONTEXT_DIM),
    "gen5d": dict(gex_feature_source="weighted_linear", global_context_source="none", gex_context_dim=None),
}
