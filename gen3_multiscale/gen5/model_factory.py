...
Gen5's arm->(gex_feature_source, global_context_source) mapping can never
silently drift from Gen4's own -- GEN5_CONTRACT.md section 2's "matched
conditioning systems" requirement.
"""
