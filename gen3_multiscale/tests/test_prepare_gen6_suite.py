...
def test_prepare_gen6_suite_writes_ten_matched_configs_without_launching(tmp_path):
    base = {
    ...
    plan = prepare_gen6_suite(
        comparison_config=str(base_path), manifest=str(manifest), output_root=str(root),
