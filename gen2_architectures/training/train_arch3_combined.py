...
def main(
    ...
    train_arch3_stage_b.main(stage_b_config, smoke_steps=smoke_steps, max_wall_clock_hours_override=stage_b_hours)
...
if __name__ == "__main__":
    ...
    main(args.stage_a_config, args.stage_b_config, args.total_hours, args.stage_a_fraction, args.smoke_steps)
